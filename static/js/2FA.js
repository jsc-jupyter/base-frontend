  ...
  function activate2FA() {
    ...
    if ($('.activate-2fa').attr('disabled') == 'disabled') {
      ...
      $.confirm({
        ...
        backgroundDismiss: '2-Factor Authentication',
        content: "We'll send you a confirmation email.<br>Please follow the activation link in that email to proceed.",
        buttons: {
          Ok: {
            text: 'REQUEST EMAIL',
            btnClass: 'btn-blue',
  ...
  function remove2FA() {
    ...
    if ($('.remove-2fa').attr('disabled') == 'disabled') {
      $.confirm({
        ...
        backgroundDismiss: '2-Factor Authentication',
        content: 'The 2-factor authentication was removed for your account.<br>You can request it again at any time.',
        buttons: {
          Ok: {
            text: 'Ok',
            btnClass: 'btn-default',
